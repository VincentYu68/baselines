...
def main():
    ...
    logger.reset()
    logger.configure('data/ppo_curriculum_150eachit_vel15_mirror4_e0015_'+args.env+'_'+str(args.seed)+'_'+str(args.anc_thres)+'_'+str(args.prog_thres)+'_'+str(args.batch_size))
