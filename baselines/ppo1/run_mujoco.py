...
def train_mirror(env_id, num_timesteps, seed):
    ...
    pposgd_mirror.learn(env, policy_fn,
            ...
            #init_policy_params = joblib.load('data/ppo_DartHumanWalker-v175_energy15_vel5_3s_mirror4_up03fwd03ltl15_spinepen1yaw001_thighyawpen005_velrewavg3_2s_dcon1_damping2kneethigh_thigh260knee100waist250_shoulder100_dqpen0_anklespring_100_5_1kpushassist4s_velrew01init/policy_params_280.pkl'),
...
def main():
    ...
    logger.reset()
    logger.configure('data/ppo_'+args.env+str(args.seed)+'_energy3_vel15_15s_mirror4_up03fwd03ltl15_spinepen1yaw001_thighyawpen005_velrewavg3_2s_dcon1_damping2kneethigh_thigh160knee100waist150_shoulder100_dqpen0_anklespring_0_1kassist3s_velrew01xinit')
