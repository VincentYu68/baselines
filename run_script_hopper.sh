...
export EXPNAME='--expname _3models_new2_'
...
if false; then
mpirun -np 4 python -m baselines.split_net.run_exp $ENVNAME $EXPNAME --seed 1 --batch $BATCHSIZE --split_iter 10 --split_percent 0.05
mpirun -np 4 python -m baselines.split_net.run_exp $ENVNAME $EXPNAME --seed 2 --batch $BATCHSIZE --split_iter 10 --split_percent 0.05
mpirun -np 4 python -m baselines.split_net.run_exp $ENVNAME $EXPNAME --seed 3 --batch $BATCHSIZE --split_iter 10 --split_percent 0.05
